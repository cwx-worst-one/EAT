...
import sys
sys.path.append("/hpc_stor03/sjtu_home/wenxi.chen/fairseq")   
sys.path.append("/hpc_stor03/sjtu_home/wenxi.chen/fairseq/examples")   
...
from .pretraining_AS2M import MaeImagePretrainingConfig, MaeImagePretrainingTask
# from fairseq.examples.data2vec.data.modality import Modality
